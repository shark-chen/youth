...
import 'edit_birthday_picker_model.dart';

/// 编辑资料-生日滚轮逻辑（从 [BirthdaySelectVM] 复制，无 UserInfoParam / BaseVM）
class EditBirthdaySheetVM {
  EditBirthdaySheetVM({
    int? minYear,
    int? maxYear,
    DateTime? initialDate,
  }) : pickerModel = EditBirthdayPickerModel(
  ...
  final EditBirthdayPickerModel pickerModel;
