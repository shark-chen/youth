...
ChatImEntity $ChatImEntityFromJson(Map<String, dynamic> json) {
  ...
  if (type != null) chatImEntity.type = type;
  final String? status = jsonConvert.convert<String>(json['status']);
  if (status != null) chatImEntity.status = status;
  final int? messageId = jsonConvert.convert<int>(json['messageId']);
  if (messageId != null) chatImEntity.messageId = messageId;
  final String? clientMsgId = jsonConvert.convert<String>(json['clientMsgId']);
  if (clientMsgId != null) chatImEntity.clientMsgId = clientMsgId;
  final String? fromUserId = jsonConvert.convert<String>(json['fromUserId']);
  if (fromUserId != null) chatImEntity.fromUserId = fromUserId;
  final String? fromNickname = jsonConvert.convert<String>(json['fromNickname']);
  if (fromNickname != null) chatImEntity.fromNickname = fromNickname;
  final String? fromAvatar = jsonConvert.convert<String>(json['fromAvatar']);
  if (fromAvatar != null) chatImEntity.fromAvatar = fromAvatar;
  final int? contentType = jsonConvert.convert<int>(json['contentType']);
  if (contentType != null) chatImEntity.contentType = contentType;
  final String? content = jsonConvert.convert<String>(json['content']);
  if (content != null) chatImEntity.content = content;
  final String? createdAt = jsonConvert.convert<String>(json['createdAt']);
  if (createdAt != null) chatImEntity.createdAt = createdAt;
  return chatImEntity;
}
...
Map<String, dynamic> $ChatImEntityToJson(ChatImEntity entity) {
  ...
  data['clientMsgId'] = entity.clientMsgId;
