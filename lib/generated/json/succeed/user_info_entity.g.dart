...
UserInfoEntity $UserInfoEntityFromJson(Map<String, dynamic> json) {
  ...
  if (id != null) userInfoEntity.id = id;
  final String? phone = jsonConvert.convert<String>(json['phone']);
  if (phone != null) userInfoEntity.phone = phone;
  final String? nickname = jsonConvert.convert<String>(json['nickname']);
  if (nickname != null) userInfoEntity.nickname = nickname;
  final String? avatar = jsonConvert.convert<String>(json['avatar']);
  if (avatar != null) userInfoEntity.avatar = avatar;
  final int? gender = jsonConvert.convert<int>(json['gender']);
  if (gender != null) userInfoEntity.gender = gender;
  final String? birthday = jsonConvert.convert<String>(json['birthday']);
  if (birthday != null) userInfoEntity.birthday = birthday;
  final int? age = jsonConvert.convert<int>(json['age']);
  if (age != null) userInfoEntity.age = age;
  final String? province = jsonConvert.convert<String>(json['province']);
  if (province != null) userInfoEntity.province = province;
  final String? city = jsonConvert.convert<String>(json['city']);
  if (city != null) userInfoEntity.city = city;
  final String? signature = jsonConvert.convert<String>(json['signature']);
  if (signature != null) userInfoEntity.signature = signature;
  final List<String>? tags = (json['tags'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (tags != null) userInfoEntity.tags = tags;
  final List<String>? photos = (json['photos'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (photos != null) userInfoEntity.photos = photos;
